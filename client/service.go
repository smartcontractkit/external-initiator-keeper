...
func (srv *Service) Run() error {
	...
	go RunWebserver(srv.config.ChainlinkToInitiatorAccessKey, srv.config.ChainlinkToInitiatorSecret, srv.keeperStore, srv.config.Port)
