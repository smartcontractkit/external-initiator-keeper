...
func (_m *EthClient) Call(result interface{}, method string, args ...interface{}) error {
	var _ca []interface{}
...
func (_m *EthClient) Dial(ctx context.Context) error {
	ret := _m.Called(ctx)
...
func (_m *EthClient) GetEthBalance(ctx context.Context, account common.Address, blockNumber *big.Int) (*assets.Eth, error) {
	ret := _m.Called(ctx, account, blockNumber)
...
func (_m *EthClient) GetLINKBalance(linkAddress common.Address, address common.Address) (*assets.Link, error) {
...
func (_m *EthClient) HeaderByNumber(ctx context.Context, n *big.Int) (*models.Head, error) {
	ret := _m.Called(ctx, n)
...
func (_m *EthClient) SendRawTx(bytes []byte) (common.Hash, error) {
	ret := _m.Called(bytes)
...
func (_m *EthClient) SubscribeNewHead(ctx context.Context, ch chan<- *models.Head) (ethereum.Subscription, error) {
